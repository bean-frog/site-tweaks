...
### -(discord.com) The old discord font "whitney" because the new one fucking sucks ([css](https://github.com/bean-frog/site-tweaks/blob/main/discord.com(web)/old-font.css))
