...
###   -(open.spotify.com) a menu with some customizable styles, like custom background, transparent elements, and a font color changer coming soon ([js](https://github.com/bean-frog/site-tweaks/tree/main/open.spotify.com))
